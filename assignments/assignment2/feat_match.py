...
def set_arguments(parser):
    ...
    parser.add_argument('--data_dir',action='store',type=str,default='./assets/Benchmarking_Camera_Calibration_2008/teddy/images',
    ...
    parser.add_argument('--out_dir',action='store',type=str,default='./assets/Benchmarking_Camera_Calibration_2008/teddy',
